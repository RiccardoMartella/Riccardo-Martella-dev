...
const hmDocPages = [
  ...
  { path: 'manual-guidance', name: 'hm-docs-manual-guidance', component: () => import('@/views/hm-docs/ManualGuidance.vue') },
  { path: 'homing-missile-script', name: 'hm-docs-homing-missile-script', component: () => import('@/views/hm-docs/HomingMissileScript.vue') },
  { path: 'player-guided-missile', name: 'hm-docs-player-guided-missile', component: () => import('@/views/hm-docs/PlayerGuidedMissileScript.vue') },
  { path: 'missile-camera-overlay', name: 'hm-docs-missile-camera-overlay', component: () => import('@/views/hm-docs/MissileCameraOverlayScript.vue') },
  ...
  { path: 'included-models', name: 'hm-docs-included-models', component: () => import('@/views/hm-docs/IncludedModels.vue') },
]

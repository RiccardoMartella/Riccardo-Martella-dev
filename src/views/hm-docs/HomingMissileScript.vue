      ...
      <table class="hm-field-table">
        ...
        <tbody>
          <tr>
            ...
            <td v-if="locale === 'en'">The PN gain (N'). Higher values produce more aggressive lead angle corrections. Typical range 2–5.</td>
            <td v-else>Il guadagno PN (N'). Valori più alti producono correzioni dell'angolo di anticipo più aggressive. Intervallo tipico 2–5.</td>
          </tr>
          <tr>
      ...
      <table class="hm-field-table">
        ...
        <tbody>
          <tr>
            ...
            <td><span class="hm-field-type">float</span></td>
            <td><span class="hm-field-default">0.15</span></td>
          ...
          <tr>
            ...
            <td><span class="hm-field-type">float</span></td>
            <td><span class="hm-field-default">1.2</span></td>
      ...
      <table class="hm-field-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span class="hm-field-type">float</span></td>
            <td><span class="hm-field-default">80.0</span></td>

...
.content-section {
  margin-bottom: 40px;
  scroll-margin-top: 80px; /* This ensures anchors don't get hidden under the fixed header */
}

.sidebar-container {
  position: sticky;
  top: 90px; /* Increased to account for fixed header */
  max-height: calc(100vh - 110px); /* Adjusted to account for fixed header */
  overflow-y: auto;
  padding: 20px;
